...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Mengubah URL menembak langsung ke localhost HTTPS (Port 443 bawaan dotnet run)
      ...
      alert('Terjadi kesalahan koneksi ke server backend. Pastikan sertifikat SSL .NET sudah tepercaya.');
    } finally {
      setLoading(false);
    }
  };
